...
public static class CategoryErrorBuilder
{
    private const string NotFoundCode = "CategoryRecordNotFound";
    private const string CreationErrorCode = "CategoryCreationError";
